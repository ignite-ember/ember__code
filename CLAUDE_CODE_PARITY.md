...
| 22  | File-op tools (read / write / edit / glob / grep / list-dir)                     | `Read`, `Write`, `Edit`, `Glob`, `Grep`                                                                                                                              | `file_read`, `save_file`, `edit_file`, `edit_file_replace_all`, `create_file`, `list_dir`, `search_code`                                                                                                                                                                                                            | ✅ parity             |
